...
import { BUSINESS_APP_STORE, BUSINESS_PLAY_STORE } from '../constants/links';
...
export default function BusinessDownloadPage() {
  return (
    <>
      <PageMeta
        title="Biznes ilovani yuklab olish — ArenaTop"
        description="ArenaTop Biznes ilovasini App Store yoki Google Play dan yuklab oling."
        path="/biznes-yuklab-olish"
      />

      <header className="dl-nav">
        <div className="container dl-nav__inner">
          <Link to="/stadioni-borlar" className="dl-nav__logo dl-nav__logo--business" aria-label="ArenaTop Biznes">
            <img src={BUSINESS_LOGO} alt="ArenaTop Biznes" />
          </Link>
          <Link to="/stadioni-borlar" className="btn btn--primary btn--sm">
            Batafsil
          </Link>
        </div>
      </header>
      ...
      <section className="app-page download-page">
        <div className="container download-page__wrap">
          <div className="download-page__hero">
            <h1>Biznes ilovani yuklab olish</h1>
            <p>Stadioningizni boshqaring — bronlar, jadval va to‘lovlar bitta ilovada.</p>
          </div>

          <div className="download-page__stores">
            <a href={BUSINESS_APP_STORE} target="_blank" rel="noopener noreferrer" className="dl-store-btn">
              <AppleIcon />
              <span>
            ...
            <a href={BUSINESS_PLAY_STORE} target="_blank" rel="noopener noreferrer" className="dl-store-btn">
              <PlayIcon />
              <span>
                <small>Yuklab oling</small>
